...
class FlowManagerTest {
    ...
    private TransportDefinition transportDefinition;

    @BeforeEach
    void setUp() {
        registry = new NodeRegistry();
        flowEngine = new FlowEngine();
        transportDefinition = new TransportDefinition("transport", "tcp:brokerurl", 2);
    ...
    void testDeployAndCheckStatus() {
        FlowDefinition def = new FlowDefinition("flow-1", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
    ...
    void testListFlows() {
        FlowDefinition def1 = new FlowDefinition("flow-2a", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
        FlowDefinition def2 = new FlowDefinition("flow-2b", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
    ...
    void testGetStatus() {
        FlowDefinition def = new FlowDefinition("flow-3", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
        flowManager.deploy(def);
    ...
    void testStopFlow() {
        FlowDefinition def = new FlowDefinition("flow-4", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
        flowManager.deploy(def);
    ...
    void testRestartFlow() {
        FlowDefinition def = new FlowDefinition("flow-5", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
        flowManager.deploy(def);
    ...
    void testRemoveFlow() {
        FlowDefinition def = new FlowDefinition("flow-6", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
        flowManager.deploy(def);
    ...
    void testRemoveRunningFlow() {
        FlowDefinition def = new FlowDefinition("flow-7", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
        flowManager.deploy(def);
    ...
    void testDuplicateIdDeploy() {
        FlowDefinition def1 = new FlowDefinition("flow-dup", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
        FlowDefinition def2 = new FlowDefinition("flow-dup", "", "", transportDefinition,List.of(dummyNodeDef), List.of());
    ...
    void testUnregisteredNodeTypeDeploy() {
        ...
        FlowDefinition def = new FlowDefinition("flow-fail", "", "", transportDefinition,List.of(unknownNode), List.of());
